...
class VerifyAccountComponent {
    ...
    checkAcces() {
        let response;
        //TODO : Necessaria una peticio per poder compravar si el email del usuari que es situa dins de currentUser ja esta donat de alta o com a minim si ha fet el intent de registrar-se
        this.main.provider.checkEmail(this.main.currentUser.email).then((res) => {
            response = res;
        }).catch((err) => {
...
VerifyAccountComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: VerifyAccountComponent, selectors: [["app-verify-account"]], decls: 9, vars: 0, consts: [[1, "content", "content-m"], [1, "card"], [1, "card-body"], [1, "text-center"], [1, "titleActivate"], [1, "loading-spinner"]], template: function VerifyAccountComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div", 0);

...
LearnComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: LearnComponent, selectors: [["app-learn"]], decls: 5, vars: 0, consts: function () { let i18n_0; if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        ...
        i18n_0 = "Bienvenido al programa beta. Estamos desarrollando una academia mundial de arte, donde todos pueden compartir sus conocimientos a trav\xE9s de clases en l\xEDnea. Este sitio no est\xE1 disponible actualmente, ya que se trata de una versi\xF3n temprana. Todav\xEDa estamos trabajando activamente en esta funci\xF3n, por lo que puede haber actualizaciones y errores frecuentes. \xA1Sigue atento!";
